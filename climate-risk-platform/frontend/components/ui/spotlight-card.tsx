...
export const GlowCard: React.FC<GlowCardProps> = ({
  ...
  const inlineStyles: React.CSSProperties & Record<string, string | number> = {
    ...
    '--radius': '14',
    '--border': '2',
    '--backdrop': 'hsl(222 47% 6% / 0.85)',
    '--backup-border': 'hsl(215 28% 17% / 0.8)',
    '--size': '220',
    '--outer': '1',
  ...
  return (
    <>
      ...
      <div
        ...
        className={`${sizeClass} rounded-2xl relative shadow-[0_1rem_2rem_-1rem_black] backdrop-blur-sm ${className}`}
      >
        <div data-glow />
        {children}
      </div>
