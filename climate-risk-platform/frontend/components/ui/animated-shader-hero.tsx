...
const Hero: React.FC<HeroProps> = ({
  ...
  // Parallax: content drifts up and fades as you scroll away
  ...
  return (
    <div ref={containerRef} className={`relative w-full h-screen ${className}`}>
      {/* Fixed canvas covers the entire page behind all content */}
      <canvas
        ref={canvasRef}
        className="fixed inset-0 w-full h-full touch-none"
        style={{ background: 'black', zIndex: 0 }}
      />
      {/* Hero Content Overlay — scroll-driven parallax */}
      <motion.div
              ...
              {trustBadge.icons && (
                <div className="flex">
                  {trustBadge.icons.map((icon, index) => (
                    <span key={index} className="text-cyan-300">{icon}</span>
                  ))}
                </div>
              )}
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          <div className="space-y-2">
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-cyan-300 via-teal-400 to-emerald-300 bg-clip-text text-transparent"
            >
              {headline.line1}
            </motion.h1>
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-teal-300 via-cyan-400 to-blue-400 bg-clip-text text-transparent"
            >
              {headline.line2}
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl lg:text-2xl text-cyan-100/90 font-light leading-relaxed max-w-3xl mx-auto"
          >
            {subtitle}
          </motion.p>
            ...
            >
              {buttons.primary && (
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/25"
                >
